...
🌐 **Русский** | [English](assembly.en.md)
...
В репозитории три прошивки: [stellarium_firmware.ino](../src/stellarium_firmware.ino) (Stellarium, USB),
[bluetooth_firmware.ino](../src/bluetooth_firmware.ino) и [wifi_firmware.ino](../src/wifi_firmware.ino) (SkySafari).
